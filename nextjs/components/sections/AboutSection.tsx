...
const fallbackPillars: BackendPillar[] = [
  {
...
const AboutSection = ({ data }: AboutSectionProps) => {
  ...
  return (
    <section id="about" className="py-12 relative overflow-hidden bg-[#07090E]">
      ...
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 w-[700px] h-[700px] bg-[#FF6B00]/10 rounded-full filter blur-[150px] pointer-events-none" />
      ...
      <div className="w-full max-w-[1700px] mx-auto px-4 md:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-3 space-y-6 order-2 lg:order-1">
            {/* Pillar 01 */}
            <div className="glass-card p-6 rounded-xl border border-white/10 hover:border-[#00C853]/50 transition-all duration-300 group bg-[#0F131D]/90 shadow-2xl">
            ...
            {/* Pillar 02 */}
            <div className="glass-card p-6 rounded-xl border border-white/10 hover:border-[#FF6B00]/50 transition-all duration-300 group bg-[#0F131D]/90 shadow-2xl">
          ...
          <div className="lg:col-span-6 space-y-8 order-1 lg:order-2">
            ...
            <div className="relative group w-full">
              ...
              <div className="absolute -inset-3 bg-[#FF6B00]/60 rounded-xl blur-2xl opacity-40 group-hover:opacity-60 transition-opacity duration-500" />

              {/* Video Box */}
              <div className="relative w-full aspect-[16/10] rounded-xl overflow-hidden border border-white/20 bg-[#07090E] shadow-2xl">
                ...
                {/* Overlay Badge */}
                <div className="absolute bottom-4 left-4 right-4 p-4 rounded-lg bg-[#0F131D]/90 backdrop-blur-md border border-white/15 flex items-center justify-between shadow-2xl">
            ...
            <div className="glass-panel p-6 md:p-8 rounded-xl border border-white/15 bg-[#0F131D]/95 shadow-2xl border-l-4 border-l-[#FF6B00]">
          ...
          <div className="lg:col-span-3 space-y-6 order-3 lg:order-3">
            {/* Pillar 03 */}
            <div className="glass-card p-6 rounded-xl border border-white/10 hover:border-purple-500/50 transition-all duration-300 group bg-[#0F131D]/90 shadow-2xl">
