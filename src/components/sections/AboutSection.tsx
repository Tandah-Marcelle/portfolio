        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700 transition-all duration-300 hover:bg-blue-700 dark:hover:bg-blue-700 group">
                <Award className="text-blue-600 mb-3 group-hover:text-white transition-colors duration-300" size={24} />
                <h3 className="font-bold text-gray-800 dark:text-gray-100 mb-2 group-hover:text-white transition-colors duration-300">5+ Competitions</h3>
                <p className="text-gray-600 dark:text-gray-400 text-sm group-hover:text-white transition-colors duration-300">Great experiences</p>
              </div>

              <div className="bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700 transition-all duration-300 hover:bg-blue-700 dark:hover:bg-blue-700 group">
                <Lightbulb className="text-blue-600 mb-3 group-hover:text-white transition-colors duration-300" size={24} />
                <h3 className="font-bold text-gray-800 dark:text-gray-100 mb-2 group-hover:text-white transition-colors duration-300">Lifelong Learner</h3>
                <p className="text-gray-600 dark:text-gray-400 text-sm group-hover:text-white transition-colors duration-300">Always asking 'why' and 'how'</p>
              </div>
            </div>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700 transition-all duration-300 hover:bg-blue-700 dark:hover:bg-blue-700 group">
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="text-base font-semibold text-gray-800 dark:text-gray-100 group-hover:text-white transition-colors duration-300">User-Focused</h3>
                  </div>
                  <p className="text-gray-600 dark:text-gray-400 text-sm group-hover:text-white transition-colors duration-300">
                ...
                <div className="bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700 transition-all duration-300 hover:bg-blue-700 dark:hover:bg-blue-700 group">
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="text-base font-semibold text-gray-800 dark:text-gray-100 group-hover:text-white transition-colors duration-300">Innovation</h3>
                  </div>
                  <p className="text-gray-600 dark:text-gray-400 text-sm group-hover:text-white transition-colors duration-300">
