          ...
          {experiences.map((exp, index) => (
            <div key={index} className="relative">
              ...
              <div className="flex items-start mb-12">
                ...
                <div className="flex-grow bg-white dark:bg-gray-800 p-4 rounded shadow-lg card-hover border border-gray-100 dark:border-gray-700">
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-1">
                    <div>
                      <h3 className="text-lg font-medium text-blue-600 dark:text-blue-400 mb-1">{exp.title}</h3>
                      <h4 className="text-base text-blue-600 dark:text-blue-400 font-semibold">{exp.company}</h4>
                    </div>
